...
The asset protocol we describe here is inspired and based off of shielded pool protocols that allows for private and arbitrary valued transactions using a shielded unspent transaction output (UTXO) model.
