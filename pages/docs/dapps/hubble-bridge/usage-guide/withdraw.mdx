...
import { Withdraw, WithdrawToken, WithdrawFixedAmount, ConfirmWithdraw, WithdrawCustomAmount, WithdrawRecipient, RelayerSelection, UnwrapWithdraw, UnwrapWithdrawToken, UnwrapWithdrawStart, WithdrawInputAmount, WithdrawInProgress, WithdrawSuccess, ChangeNoteCopied } from '../../../../../components/images/bridge/usage-guide/withdraw/Withdraw';
