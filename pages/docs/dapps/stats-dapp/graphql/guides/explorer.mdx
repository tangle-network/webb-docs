---
title: About the GraphQL Explorer
...
1. In the **GraphQL Endpoint** field, enter `data_point`.
...
**Note:** recommends checking for errors before using data in a production environment. In GraphQL, failure is not total: portions of GraphQL queries may succeed while others fail.
