...
The Proposal page visualizes the propser threshold parameters, and all the proposals that have been proposed to the DKG to be signed. Proposals are
essentially messages that have been propsed to enact a change within the protocol. Proposals are proposed by proposers and must pass a threshold in
...
all proposal types please refer to the application specific proposals and global proposals [here](/docs/protocols/asset-transfer/governance-proposals), and [here](/docs/protocols/dkg/governance/proposals).
