...
in running a DKG Authority please refer to the node operators section of the docs [here](/docs/tangle-network/node-operators/quickstart).
...
and idenitfying information if it is set. This may include, a link to their website, twitter profile, or email address.
