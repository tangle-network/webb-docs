...
Distributed Key Generation (DKG) protocol that runs within Webb based chains such as Tangle Network and AranaAlpha Network. The dApp provides visibility into the current
