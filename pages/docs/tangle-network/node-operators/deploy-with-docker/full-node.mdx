...
docker run --rm -it --entrypoint ./tangle-collator -v ~/webb/tangle/full-node:/data ghcr.io/webb-tools/tangle/tangle-collator:main \
...
docker run --rm -it -v ~/webb/tangle/full-node:/data ghcr.io/webb-tools/tangle/tangle-collator:main \
    key insert --base-path /data \
    --chain /data/chainspecs/parachain.json \
    --scheme Sr25519 \
    --key-type imon
...
```
ls ~/webb/tangle/full-node/chains/*/keystore
