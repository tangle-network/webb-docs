...
docker run --rm -it --entrypoint ./tangle-parachain -v ~/webb/tangle/collator:/data ghcr.io/webb-tools/tangle/tangle-parachain:main \
...
docker run --rm -it --entrypoint ./tangle-parachain -v ~/webb/tangle/collator:/data ghcr.io/webb-tools/tangle/tangle-parachain:main \
    ...
    --key-type aura
```
**Im-online Keys** - __these keys are optional__
```
docker run --rm -it -v ~/webb/tangle/collator:/data ghcr.io/webb-tools/tangle/tangle-parachain:main \
    key insert --base-path /data \
    --chain /data/chainspecs/parachain.json \
    --scheme Sr25519 \
    --key-type imon
