...
<Callout>
Always refer to the official Substrate documentation for exhaustive details on [flags, subcommands, and other CLI tools available for Substrate-based nodes, including Tangle.](https://docs.substrate.io/reference/command-line-tools/node-template/)
</Callout>
