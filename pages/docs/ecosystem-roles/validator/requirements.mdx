...
This feature flag is used to start the embedded tx relayer with tangle node, you should build node with this flag if you intend to use the node for any evm transaction following
...
This feature flag is used to start the embedded light client with tangle node, you should build node with this flag if you intend to use the node for any evm transaction following
