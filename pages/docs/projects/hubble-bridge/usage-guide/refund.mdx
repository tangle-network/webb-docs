...
Alternatively, users can choose to proceed with the withdrawal of shielded ERC-20 tokens to the clean address. In this case, they would need to perform *another separate withdrawal* from the bridge to obtain the native tokens required for gas. **This option may be more suitable if users prefer to have the shielded ERC-20 tokens in a separate wallet or address from their native tokens.**
