...
<Callout type="idea">
  You may make use of the `--tmp` flag. This will start the relayer with a temporary database. This is useful for testing, but you should not use this flag in production.
</Callout>
