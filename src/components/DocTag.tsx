  ...
  return (
    <>
      <div className="inline-block text-xs mb-5">
        <button className="bg-webbBlue dark:bg-webbDark bg-opacity-5 px-4 py-2 border border-webbPurple dark:border-webbWhite border-opacity-30 rounded cursor-text">
          {props.difficulty === 1
            ? 'Beginner'
            : props.difficulty === 2
            ? 'Intermediate'
        ...
        {props.duration && (
          <button className="bg-webbBlue dark:bg-webbDark bg-opacity-5 ml-4 px-4 py-2 border border-webbPurple dark:border-webbWhite border-opacity-30 rounded cursor-text">
            <svg
