      ...
      <div className="hidden lg:inline-block ml-16 float-right max-w-xs rounded bg-webbGray-light dark:bg-webbDark shadow-lg">
        ...
        <div className="p-6">
          ...
          <a
            ...
            rel="noreferrer"
          >
            <button className="bg-webbDarkest dark:bg-darkBackground py-3 w-full rounded text-lg text-white font-bold transform transition-all duration-300 ease-in-out hover:bg-opacity-90">
              Go to Playground
            </button>
          </a>
        </div>
