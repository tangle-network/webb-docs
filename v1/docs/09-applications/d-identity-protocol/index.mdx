...
In our version of the asset protocol we will leverage Webb’s technology to design an interoperable identity protocol that allows both for signaling on the same chain as the group was initially created or on one of the other connected chains
