...
$$
\textbf{commitment} = Poseidon(\text{chain}_\text{id},\text{amount}, \text{public}_\text{key}, \text{blinding})
$$
...
$$
\textbf{signature} = Poseidon(\text{private}_\text{key}, \textbf{commitment}, \text{path}_\text{index})
$$
$$
\textbf{nullifier} = Poseidon(\textbf{commitment}, \text{path}_\text{index}, \textbf{signature}) 
$$
...
## Formal description
<img width="728" alt="image" src="https://user-images.githubusercontent.com/13153687/180037416-e3aeaa3a-6d1a-4dcb-bb6a-bd912e8ece25.png">
