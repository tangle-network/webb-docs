...
VAnchor protocols. The users generate zero-knowledge proof data, format a proper payload, and submit it to a 
...
as it pertains to the Anchor Protocol. The relayer is responsible for submitting the unsigned and signed anchor 
