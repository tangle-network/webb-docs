---
title: Overview
slug: /v1/node-operators/monitor-node
version: '1.0'
section: docs
...
The following is a guide outlining the steps to setup monitoring for an Eggnet node. If you do not have Eggnet node setup yet, please 
review the How to run an Eggnet node setup guide [here](https://docs.webb.tools/v1/node-operators/run-eggnet-node). It is important to note that 
...
- **Eggnet Node** natively provides metrics for monitoring.
