...
The collator rewards are paid out every block, the rewards consists of multiple components, mainly the transaction 
fees from all transactions in the block, tips paid by users and network reward amount. The collator reward is initially paid out from
the collator reward pot alloted at the time of genesis. Once the initial genesis supply for collator
