...
export const AvailableNotesManage = (props) => {
  return (
    ...
    <div className="block dark:hidden">
      <Image src={AvailableNotesManageLight} height={props.height} alt="available notes manager" />
    </div>
    <div className="hidden dark:block">
      <Image src={AvailableNotesManageDark} height={props.height} alt="available notes manager" />
    </div>
    </>
  )
};
...
export const AvailableNotesQuick = () => {
    return (
      <>
      <div className="block dark:hidden">
        <Image src={AvailableNotesQuickLight} alt="available notes quick action" />
      </div>
      <div className="hidden dark:block">
        <Image src={AvailableNotesQuickDark}alt="available notes quick action" />
      </div>
      </>
    )
};
