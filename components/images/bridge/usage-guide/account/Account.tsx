...
export const ConnectWallet = (props) => {
  return (
    ...
    <div className="block dark:hidden">
      <Image src={ConnectWalletLight} height={props.height} alt="connect wallet light" />
    </div>
    <div className="hidden dark:block">
      <Image src={ConnectWalletDark} height={props.height} alt="connect wallet dark" />
    </div>
    </>
  )
};
...
export const CreateNoteAccountPrompt = () => {
    return (
      <>
      <div className="block dark:hidden">
        <Image src={CreateAccountPromptLight} alt="create account prompt light" />
      </div>
      <div className="hidden dark:block">
